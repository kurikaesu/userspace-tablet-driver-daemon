...
#ifndef USERSPACE_TABLET_DRIVER_DAEMON_ARTIST_PRO_16_H
#define USERSPACE_TABLET_DRIVER_DAEMON_ARTIST_PRO_16_H


#include "xp_pen_unified_device.h"

class artist_pro_16 : public xp_pen_unified_device {
public:
    artist_pro_16();
...
#endif //USERSPACE_TABLET_DRIVER_DAEMON_ARTIST_PRO_16_H
