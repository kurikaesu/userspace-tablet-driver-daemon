...
#ifndef USERSPACE_TABLET_DRIVER_DAEMON_ARTIST_15_6_PRO_H
#define USERSPACE_TABLET_DRIVER_DAEMON_ARTIST_15_6_PRO_H


#include "xp_pen_unified_device.h"

class artist_15_6_pro : public xp_pen_unified_device {
public:
    artist_15_6_pro();
...
#endif //USERSPACE_TABLET_DRIVER_DAEMON_ARTIST_15_6_PRO_H
